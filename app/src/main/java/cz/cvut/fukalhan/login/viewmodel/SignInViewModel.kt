...
class SignInViewModel : ViewModel(), KoinComponent {
    ...
    val newPassword: MutableLiveData<PasswordChangeEmailSentState> by lazy { MutableLiveData<PasswordChangeEmailSentState>() }
    ...
    fun forgotPassword(email: String) {
        viewModelScope.launch {
            newPassword.postValue(loginFacade.sendChangePasswordEmail(email))
        }
    }
}